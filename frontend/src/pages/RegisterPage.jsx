...
import { User, Mail, Lock, MapPin, Briefcase, Sprout, Loader2 } from 'lucide-react';
...
const RegisterPage = () => {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            if (res && res.role) {
                toast.success('Account created successfully! Welcome to FarmEarn.');
                navigate(`/dashboard/${res.role.toLowerCase()}`);
            }
        } catch (error) {
            // Error is handled by the axios interceptor (toast shown there)
        } finally {
